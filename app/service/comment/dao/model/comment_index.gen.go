...
type CommentIndex struct {
	...
	CommentFloor int32     `gorm:"column:comment_floor;not null;default:1" json:"comment_floor"`  // 当前评论层数 (若是回复则为 0)
	CommentID    int64     `gorm:"column:comment_id;not null" json:"comment_id"`                  // 回复对象 id (若是评论则为 0)
	ReplyFloor   int32     `gorm:"column:reply_floor;not null;default:1" json:"reply_floor"`      // 当前回复层数 (若是评论则为 0)
