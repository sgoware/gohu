...
func GetCommentSubjectInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetCommentSubjectInfoReq
		...
		l := logic.NewGetCommentSubjectInfoLogic(r.Context(), svcCtx)

		res, err := l.GetCommentSubjectInfo(&req)
		if err != nil {
