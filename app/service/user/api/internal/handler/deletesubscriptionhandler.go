...
func DeleteSubscriptionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteSubscriptionReq
		...
		l := logic.NewDeleteSubscriptionLogic(r.Context(), svcCtx)

		res, err := l.DeleteSubscription(&req)
		if err != nil {
