...
func GetObjInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetObjInfoReq
		...
		l := logic.NewGetObjInfoLogic(r.Context(), svcCtx)

		res, err := l.GetObjInfo(&req)
		if err != nil {
