...
func CreateCollectionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewCreateCollectionLogic(r.Context(), svcCtx)

		res, err := l.CreateCollection(&req)
		if err != nil {
