...
func CreateSubscriptionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateSubscriptionReq
		...
		l := logic.NewCreateSubscriptionLogic(r.Context(), svcCtx)

		res, err := l.CreateSubscription(&req)
		if err != nil {
